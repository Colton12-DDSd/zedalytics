...
async def insert_race_and_participants(race, participants):
    async with engine.begin() as conn:
        await conn.execute(text("""
            INSERT INTO races (id, name, start_time, finish_time, pots_total)
            VALUES (:id, :name, :start_time, :finish_time, :pots_total)
            ...
            try:
                ...
                for p in participants_data:
                    ...
                    participants.append({
                        ...
                        "sectional_positions": json.dumps(p.get("sectionalPositions", []))
                    })
